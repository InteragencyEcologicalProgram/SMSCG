...
#read in data
zoop_cb <- read_csv("./EDI/data_input/zooplankton/SMSCG_CBNet_2018to2021CPUE_7April2022.csv") 
...
gatelog <- read_csv("./EDI/data_input/gatedailylog_1988-2021.csv") 
#glimpse(gatelog)
...
#write_csv(gatelog2,"./EDI/data_output/SMSCG_GateDailyLog_1988-2021.csv")

#write_csv(zoop_cb2,"./EDI/data_output/SMSCG_Zooplankton_CBNet_2018to2021.csv")
