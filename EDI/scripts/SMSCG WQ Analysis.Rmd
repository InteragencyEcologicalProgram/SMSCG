...
-Remove all WQA data from this file (not QC'd and doesn't include 2023 - will add this data later from different source)
```{r}
...
-Export data for EDI
```{r}
#use write_csv function to export the cleaned up WQ data

write_csv(df_comb, "C:/R_coding/SMSCG_MB/Data/SMSCG_wq_data_2017-2023_clean.csv")
```
